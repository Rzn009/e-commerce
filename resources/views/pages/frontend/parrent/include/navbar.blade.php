            ...
            <div class="w-auto">
                <ul class="fixed bg-white inset-0 z-0 flex flex-col invisible items-center justify-center opacity-0 md:visible md:flex-row md:bg-transparent md:relative md:opacity-100 md:flex md:items-center"
                        ...
                        @if (Auth::user()->role == 'admin')
                            <li class="mx-3 py-6 md:py-0">
                                <a href="{{ route('admin.dashboard') }}"
                                    class="bg-pink-400 text-black hover:bg-black hover:text-pink-400 rounded-full px-8 py-3 mt-4 inline-block flex-none transition duration-200">Dashboard</a>
                            </li>
                    ...
                    @else
                        <li class="mx-3 py-6 md:py-0">
                            <a href="/login"
                                class="bg-pink-400 text-black hover:bg-black hover:text-pink-400 rounded-full px-8 py-3 mt-4 inline-block flex-none transition duration-200">Login</a>
                        </li>
                        <li class="mx-3 py-6 md:py-0">
                            <a href="/register"
                                class="bg-pink-400 text-black hover:bg-black hover:text-pink-400 rounded-full px-8 py-3 mt-4 inline-block flex-none transition duration-200">Register</a>
                        </li>
                    @endif
