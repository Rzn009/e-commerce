...
<body>
    ...
    @include('pages.frontend.parrent.include.navbar')

    @yield('content')
    

    @include('pages.frontend.parrent.include.footer')
    ...
    <script src="https://www.go ogle-analytics.com/analytics.js" async></script>
